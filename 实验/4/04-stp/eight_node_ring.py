...
def run(file):
    ...
    if isinstance(topo,ringTopo8):
        ...
        os.system("./dump_output.sh 8 >dump.txt")
        os.system("cat dump.txt")
        os.system("diff dump.txt ref8.txt -y")
        if filecmp.cmp("dump.txt","ref8.txt"):
        ...
        os.system("./dump_output.sh 4 >dump.txt")
        os.system("cat dump.txt")
        os.system("diff dump.txt ref4.txt -y")
        if filecmp.cmp("dump.txt","ref4.txt"):
            print("result is true")
            return 1
        else:
            print("result is false")
