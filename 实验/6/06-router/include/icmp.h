...
#define ICMP_COPIED_DATA_LEN 8 /* the eight byte after */
// types of icmp ping
#define ICMP_ECHOREQUEST 8 /* Echo Request			ping request		*/
#define ICMP_ECHOREPLY 0   /* Echo Reply           ping reply        */
/*types for unreach and exceeded*/
#define ICMP_DEST_UNREACH 3	  /* Destination Unreachable  not found in router    */
#define ICMP_TIME_EXCEEDED 11 /* Time Exceeded            ttl    */
